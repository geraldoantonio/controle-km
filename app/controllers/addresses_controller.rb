class AddressesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @address.save
        format.html { redirect_to @address, notice: I18n.t('messages.created_with', item: @address.description) }
  ...
  def update
    respond_to do |format|
      if @address.update(address_params)
        format.html { redirect_to @address,  notice: I18n.t('messages.updated_with', item: @address.description) }
  ...
  def destroy
    @address.destroy
    respond_to do |format|
      format.html { redirect_to addresses_url, notice:  I18n.t('messages.destroyed_with', item: @address.description) }
